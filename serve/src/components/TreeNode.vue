...
.node-dir:hover { background: #161d2a; color: var(--text) }
.icon { color: var(--muted); width: 10px; flex-shrink: 0; font-style: normal }
.node-dir .name { font-weight: 600 }
.node-children { margin-left: 14px; border-left: 1px solid var(--border) }
.node-file {
  padding: 3px 8px;
  cursor: pointer;
  color: #7b8fa3;
...
.node-file:hover { background: #161d2a; color: var(--text) }
.loading { padding: 3px 8px; color: var(--muted); font-style: italic }
</style>
